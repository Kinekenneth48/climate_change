...
file_listr45 = c("D:/data-raw/NCAR/vic/ACCESS1-0/historical/SWE.2005.v0.nc",
  file_listr45)
...
# combine max SWE maps into a single multilayer file
max_swe_vic_rcp45_access10 <- terra::rast(max_swe_raster_r45)
...
file_listr85 = c("D:/data-raw/NCAR/vic/ACCESS1-0/historical/SWE.2005.v0.nc",
                 file_listr85)
...
# combine max SWE maps into a single multilayer file
max_swe_vic_rcp85_access10 <- terra::rast(max_swe_raster_r85)
