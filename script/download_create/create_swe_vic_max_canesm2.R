...
# Define the path
path <- "D:/data-raw/NCAR/vic/CanESM2/historical"
...
max_swe_vic_hist_canesm2 <- terra::rast(max_swe_raster)


# save data
terra::writeRaster(max_swe_vic_hist_canesm2,
                   filename = "E:/data-raw/NCAR/CanESM2/historical/max_swe_vic_hist_canesm2.tif",
                   overwrite = TRUE
)
...
# Define the path
path <- "D:/data-raw/NCAR/vic/CanESM2/rcp45"
...
file_listr45 = c("D:/data-raw/NCAR/vic/CanESM2/historical/SWE.2005.v0.nc",
                 file_listr45)
...
# combine max SWE maps into a single multilayer file
max_swe_vic_rcp45_canesm2 <- terra::rast(max_swe_raster_r45)


# save data
terra::writeRaster(max_swe_vic_rcp45_canesm2,
                   filename = "E:/data-raw/NCAR/CanESM2/future/max_swe_vic_rcp45_canesm2.tif",
                   overwrite = TRUE
)
...
# Define the path
path <- "D:/data-raw/NCAR/vic/CanESM2/rcp85"
...
file_listr85 = c("D:/data-raw/NCAR/vic/CanESM2/historical/SWE.2005.v0.nc",
                 file_listr85)
...
# combine max SWE maps into a single multilayer file
max_swe_vic_rcp85_canesm2 <- terra::rast(max_swe_raster_r85)


# save data
terra::writeRaster(max_swe_vic_rcp85_canesm2,
                   filename = "E:/data-raw/NCAR/CanESM2/future/max_swe_vic_rcp85_canesm2.tif",
                   overwrite = TRUE
)
