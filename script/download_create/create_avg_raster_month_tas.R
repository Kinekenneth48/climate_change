...
tictoc::tic()
# Compute the mean raster layer across all SpatRasters in the dataset
loca_future_r_comb_tas_2044 <- terra::app(raster_data, mean)
tictoc::toc()



# Save the computed mean raster layer to disk
terra::writeRaster(loca_future_r_comb_tas_2044,
  filename = "data-raw/raster/loca_future_r_comb_tas_2044.tif",
  overwrite = TRUE
)

remove(raster_list, raster_data, loca_future_r_comb_tas_2044)
...
tictoc::tic()
# Compute the mean raster layer across all SpatRasters in the dataset
loca_future_r_comb_tas_2074 <- terra::app(raster_data, mean)
tictoc::toc()



# Save the computed mean raster layer to disk
terra::writeRaster(loca_future_r_comb_tas_2074,
                   filename = "data-raw/raster/loca_future_r_comb_tas_2074.tif",
                   overwrite = TRUE
)

remove(raster_list, raster_data, loca_future_r_comb_tas_2074)
...
tictoc::tic()
# Compute the mean raster layer across all SpatRasters in the dataset
loca_future_r_comb_tas_2100 <- terra::app(raster_data, mean)
tictoc::toc()



# Save the computed mean raster layer to disk
terra::writeRaster(loca_future_r_comb_tas_2100,
                   filename = "data-raw/raster/loca_future_r_comb_tas_2100.tif",
                   overwrite = TRUE
)

remove(raster_list, raster_data, loca_future_r_comb_tas_2100)
