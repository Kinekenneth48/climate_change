...
r45 <- terra::rast("E:/data-raw/NCAR/CanESM2/future/max_swe_vic_rcp45_canesm2.tif")
r85 <- terra::rast("E:/data-raw/NCAR/CanESM2/future/max_swe_vic_rcp85_canesm2.tif")
...
ggplot() +
  ...
  xlab("Longitude") +
  ylab("Latitude") +
  ggtitle('canesm2: RCP45 MEAN CHANGE') +
...
ggplot() +
  ...
  xlab("Longitude") +
  ylab("Latitude") +
  ggtitle('canesm2: RCP45 SD CHANGE') +
  theme(panel.background = element_rect(fill = "white", colour = "grey50")) +
  coord_sf(crs = 4326) +
  theme(
    legend.position = c(0.9, 0.23),
...
ggplot() +
  ...
  xlab("Longitude") +
  ylab("Latitude") +
  ggtitle('canesm2: RCP85 MEAN CHANGE') +
  theme(panel.background = element_rect(fill = "white", colour = "grey50")) +
  coord_sf(crs = 4326) +
  theme(
    legend.position = c(0.9, 0.23),
...
ggplot() +
  ...
  xlab("Longitude") +
  ylab("Latitude") +
  ggtitle('canesm2: RCP85 SD CHANGE') +
  theme(panel.background = element_rect(fill = "white", colour = "grey50")) +
  coord_sf(crs = 4326) +
  theme(
    legend.position = c(0.9, 0.23),
