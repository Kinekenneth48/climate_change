...
rcp45_tmean_loca1 <- terra::rast("E:/data-raw/loca1/access10/rcp45_tmean_loca1.tif")
rcp85_tmean_loca1 <- terra::rast("E:/data-raw/loca1/access10/rcp85_tmean_loca1.tif")
hist_tmean_loca1 <- terra::rast("E:/data-raw/loca1/access10/hist_tmean_loca1.tif")
