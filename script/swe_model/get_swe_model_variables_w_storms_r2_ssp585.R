...
# load data
# ============================================================================#
pr_r2 <- terra::rast("D:/data-raw/loca/ACCESS-CM2/pr/future/day/pr.ACCESS-CM2.ssp585.r2i1p1f1.2015-2044.LOCA_16thdeg_v20220519.nc")
pr_r22 <- terra::rast("D:/data-raw/loca/ACCESS-CM2/pr/future/day/pr.ACCESS-CM2.ssp585.r2i1p1f1.2045-2074.LOCA_16thdeg_v20220519.nc")
pr_r222 <- terra::rast("D:/data-raw/loca/ACCESS-CM2/pr/future/day/pr.ACCESS-CM2.ssp585.r2i1p1f1.2075-2100.LOCA_16thdeg_v20220519.nc")

tmax_r2 <- terra::rast("data-raw/test_r2/tasmax.ACCESS-CM2.ssp585.r2i1p1f1.2015-2044.LOCA_16thdeg_v20220413.nc")
tmax_r22 <- terra::rast("data-raw/test_r2/tasmax.ACCESS-CM2.ssp585.r2i1p1f1.2045-2074.LOCA_16thdeg_v20220413.nc")
tmax_r222 <- terra::rast("data-raw/test_r2/tasmax.ACCESS-CM2.ssp585.r2i1p1f1.2075-2100.LOCA_16thdeg_v20220413.nc")

tmin_r2 <- terra::rast("data-raw/test_r2/tasmin.ACCESS-CM2.ssp585.r2i1p1f1.2015-2044.LOCA_16thdeg_v20220413.nc")
tmin_r22 <- terra::rast("data-raw/test_r2/tasmin.ACCESS-CM2.ssp585.r2i1p1f1.2045-2074.LOCA_16thdeg_v20220413.nc")
tmin_r222 <- terra::rast("data-raw/test_r2/tasmin.ACCESS-CM2.ssp585.r2i1p1f1.2075-2100.LOCA_16thdeg_v20220413.nc")




loca_pr_r2_ssp585_day <- c(pr_r2, pr_r22, pr_r222)
...
tictoc::tic()
writeRaster(loca_pr_r2_ssp585_day, 
            "data-raw/test_r2//loca_pr_r2_ssp585_day.tif",
            overwrite=TRUE)
