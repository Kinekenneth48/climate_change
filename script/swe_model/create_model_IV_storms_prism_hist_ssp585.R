...
temp_diff_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/temp_diff_hist.tif")
mean_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/mean_temp_hist.tif")
total_ppt_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/total_ppt_hist.tif")
snow_window_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/snow_window_hist.tif")

storm_one_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/storm_one_temp_hist.tif")
storm_two_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/storm_two_temp_hist.tif")
storm_three_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/storm_three_temp_hist.tif")
storm_one_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/storm_one_hist.tif")
storm_two_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/storm_two_hist.tif")
storm_three_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/hist/model_vars/storm_three_hist.tif")
...
# Create a sequence of years from 1951 to 2014
...
for (i in 1:nlyr(temp_diff_layers)) {
  ...
  # Extract year from 1951 to 2014 based on loop iteration
  year <- years[i]
  terra::time(test_data_per_year) = rep(year, nlyr(test_data_per_year))
  
  # Construct file name for the output raster file
  file_name <- paste0("E:/data-raw/swe_model_vars/ssp585/hist/test_data/test_data_storm_prism_", year, ".tif")
...
tif_files <- list.files("E:/data-raw/swe_model_vars/ssp585/hist/test_data/",
...
for (i in 1:length(tif_files)) {
  ...
  # Construct file name for the output raster file
  file_name <- paste0("E:/data-raw/swe_model_vars/ssp585/hist/prediction/rf/pred_hist_ssp585_",
                      year, ".tif")
