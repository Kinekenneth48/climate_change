...
temp_diff_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/temp_diff_r2_ssp585.tif")
mean_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/mean_temp_r2_ssp585.tif")
total_ppt_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/total_ppt_r2_ssp585.tif")
snow_window_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/snow_window_r2_ssp585.tif")

storm_one_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/storm_one_temp_r2_ssp585.tif")
storm_two_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/storm_two_temp_r2_ssp585.tif")
storm_three_temp_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/storm_three_temp_r2_ssp585.tif")
storm_one_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/storm_one_r2_ssp585.tif")
storm_two_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/storm_two_r2_ssp585.tif")
storm_three_layers <- terra::rast("E:/data-raw/swe_model_vars/ssp585/r2/r2_model_vars/storm_three_r2_ssp585.tif")
...
for (i in 1:nlyr(temp_diff_layers)) {
  ...
  file_name <- paste0("E:/data-raw/swe_model_vars/ssp585/r2/test_data/test_data_storm_prism_", year, ".tif")
...
tif_files <- list.files("E:/data-raw/swe_model_vars/ssp585/r2/test_data/",
...
for (i in 1:length(tif_files)) {
  ...
  # Construct file name for the output raster file
  file_name <- paste0("E:/data-raw/swe_model_vars/ssp585/r2/prediction/rf/pred_r2_ssp585_",
                      year, ".tif")
