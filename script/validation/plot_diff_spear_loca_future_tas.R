...
loca_future_tas_2044 <- terra::rast(x = "data-raw/raster/loca_future_r_comb_tas_2044.tif")
loca_future_tas_2074 <- terra::rast(x = "data-raw/raster/loca_future_r_comb_tas_2074.tif")
loca_future_tas_2100 <- terra::rast(x = "data-raw/raster/loca_future_r_comb_tas_2100.tif")
...
plot(crop(single_per_diff_future_tas_2044_2100, usa_extent),
  ...
  breaks = my_breaks, main = "Mean Difference of Average Monthly Surface Temperature between future SPEAR and LOCA (in K)",
...
plot(crop(single_per_diff_future_tas_2044, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Difference of Average Monthly Surface Temperature between future SPEAR and LOCA (2014-2044) in K",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
...
plot(crop(single_per_diff_future_tas_2074, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Difference of Average Monthly Surface Temperature between future SPEAR and LOCA (2045-2074) in K",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
...
plot(crop(single_per_diff_future_tas_2100, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean of Average Monthly Surface Temperature between future SPEAR and LOCA (2075-2100) in K",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
