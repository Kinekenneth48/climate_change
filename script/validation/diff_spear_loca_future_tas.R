...
plot(crop(single_per_diff_future_tas_2044_2100, usa_extent),
  ...
  breaks = my_breaks, main = "Mean Percentage Difference of Average Surface Temperature between future SPEAR and LOCA",
...
plot(crop(single_per_diff_future_tas_2044, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Percentage Difference of Average Surface Temperature between future SPEAR and LOCA (2014-2044)",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
...
plot(crop(single_per_diff_future_tas_2074, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Percentage Difference of Average Surface Temperature between future SPEAR and LOCA (2045-2074)",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
...
plot(crop(single_per_diff_future_tas_2100, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Difference of Average Surface Temperature between future SPEAR and LOCA (2075-2100)",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
