...
# load data
# ============================================================================#
spear_future_pr <- terra::rast(x = "data-raw/raster/spear_future_r_comb_pr.tif")
loca_future_pr_2044 <- terra::rast(x = "data-raw/raster/loca_future_r_comb_pr_2044_c585.tif")
loca_future_pr_2074 <- terra::rast(x = "data-raw/raster/loca_future_r_comb_pr_2074_c585.tif")
loca_future_pr_2100 <- terra::rast(x = "data-raw/raster/loca_future_r_comb_pr_2100_c585.tif")
...
time_values <- terra::time(spear_future_pr)
...
spear_future_pr_filtered_2044 <- spear_future_pr[[filtered_indices_2044]]
spear_future_pr_filtered_2074 <- spear_future_pr[[filtered_indices_2074]]
spear_future_pr_filtered_2100 <- spear_future_pr[[filtered_indices_2100]]
...
loca_future_pr_filtered_2044_2100 <- c(
  loca_future_pr_2044,
  loca_future_pr_2074,
  loca_future_pr_2100
)
...
# Subset the raster to keep only the filtered layers
spear_future_pr_filtered_2044_2100 <- spear_future_pr[[filtered_indices_loca]]
...
crs_r_fine_agg <- crs(loca_future_pr_filtered_2044_2100)
crs_spear_filtered <- crs(spear_future_pr_filtered_2044_2100)
...
if (crs_r_fine_agg != crs_spear_filtered) {
  ...
  loca_future_pr_filtered_2044_2100 <- terra::project(
    x = loca_future_pr_filtered_2044_2100,
...
loca_future_pr_crop <- terra::crop(
  loca_future_pr_filtered_2044_2100,
  terra::ext(spear_future_pr_filtered_2044_2100)
)

# Resample the finer raster to match the coarser raster
loca_future_pr_resampled <- terra::resample(loca_future_pr_crop,
...
usa_boundary_reproj <- sf::st_transform(
  usa_boundary,
  crs(single_per_diff_future_pr_2044_2100)
)
...
plot(crop(single_per_diff_future_pr_2044_2100, usa_extent),
  ...
  breaks = my_breaks, main = "Mean Percentage Difference of Average Precipitation between future SPEAR and LOCA - C585",
...
# ============================================================================#
# Check CRS of both SpatRaster
crs_r_fine_agg <- crs(loca_future_pr_2044)
crs_spear_filtered <- crs(spear_future_pr_filtered_2044)
...
if (crs_r_fine_agg != crs_spear_filtered) {
  ...
  # Transform one raster to match the CRS of the other
  loca_future_pr_2044 <- terra::project(
    x = loca_future_pr_2044,
    y = crs_spear_filtered
  )
} else {
  message("The CRS of both SpatRaster match. You can proceed.")
...
loca_future_pr_crop <- terra::crop(
  loca_future_pr_2044,
  terra::ext(spear_future_pr_filtered_2044)
)
...
usa_boundary_reproj <- sf::st_transform(
  usa_boundary,
  crs(single_per_diff_future_pr_2044)
)
...
plot(crop(single_per_diff_future_pr_2044, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Percentage Difference of Average Precipitation between future SPEAR and LOCA (2014-2044)-(C585)",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
...
# ============================================================================#
# Check CRS of both SpatRaster
crs_r_fine_agg <- crs(loca_future_pr_2074)
crs_spear_filtered <- crs(spear_future_pr_filtered_2074)
...
if (crs_r_fine_agg != crs_spear_filtered) {
  ...
  # Transform one raster to match the CRS of the other
  loca_future_pr_2074 <- terra::project(
    x = loca_future_pr_2074,
    y = crs_spear_filtered
  )
} else {
  message("The CRS of both SpatRaster match. You can proceed.")
...
loca_future_pr_crop <- terra::crop(
  loca_future_pr_2074,
  terra::ext(spear_future_pr_filtered_2074)
)
...
usa_boundary_reproj <- sf::st_transform(
  usa_boundary,
  crs(single_per_diff_future_pr_2074)
)
...
plot(crop(single_per_diff_future_pr_2074, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Percent Difference of Average Precip. between future SPEAR and LOCA(2045-2074)-(C585)",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
...
# ============================================================================#
# Check CRS of both SpatRaster
crs_r_fine_agg <- crs(loca_future_pr_2100)
crs_spear_filtered <- crs(spear_future_pr_filtered_2100)
...
if (crs_r_fine_agg != crs_spear_filtered) {
  ...
  # Transform one raster to match the CRS of the other
  loca_future_pr_2100 <- terra::project(
    x = loca_future_pr_2100,
    y = crs_spear_filtered
  )
} else {
  message("The CRS of both SpatRaster match. You can proceed.")
...
loca_future_pr_crop <- terra::crop(
  loca_future_pr_2100,
  terra::ext(spear_future_pr_filtered_2100)
)
...
usa_boundary_reproj <- sf::st_transform(
  usa_boundary,
  crs(single_per_diff_future_pr_2100)
)
...
plot(crop(single_per_diff_future_pr_2100, usa_extent),
     col = colorRampPalette(brewer.pal(9, "RdYlBu"))(length(my_breaks) - 1),
     breaks = my_breaks, main = "Mean Percent Difference of Average Precip. between future SPEAR and LOCA (2075-2100)-(C585)",
     plg = list(legend = legend_labels)
)
plot(st_geometry(usa_boundary_reproj), add = TRUE)
