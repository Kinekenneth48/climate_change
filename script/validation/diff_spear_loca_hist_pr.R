...
multiple_per_diff_hist_pr <- ((spear_hist_pr_filtered - loca_hist_pr_resampled) /
  (spear_hist_pr_filtered)) * 100
...
plot(crop(single_per_diff_hist_pr, usa_extent),
  ...
  breaks = my_breaks, main = "Mean Percentage Difference of Average Precipitatin between historical SPEAR and LOCA",
