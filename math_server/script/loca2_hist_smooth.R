...
ssp585_hist_para_ms_6km_smooth <- terra::app(tif_hist,
                                      fun = gev_fit_para_mix_stat,
                                      cores = 25
)
names(ssp585_hist_para_ms_6km_smooth) <- c("loc", "loctrend", "scale", "shape", "perzero")

ssp585_hist_para_ms_6km_smooth[["shape"]] = smooth_shape[["shape"]]

writeRaster(ssp585_hist_para_ms_6km_smooth,
            "../data-raw/swe/loca2_swe/ssp585/ssp585_hist_para_ms_6km_smooth.tif",
            overwrite = TRUE
)
...
ssp585_hist_ms_rtl_6km_smooth <- terra::app(ssp585_hist_para_ms_6km_smooth,
                                     fun = simulate_loads, n = 1000000,
                                     t = 50, gr = gr_model, cores = 25
)
names(ssp585_hist_ms_rtl_6km_smooth) <- c("RT_I", "RT_II", "RT_III", "RT_IV")
...
################################################################################
ssp585_hist_ms_rtl_6km_smooth <- ssp585_hist_ms_rtl_6km_smooth * 20.8855

writeRaster(ssp585_hist_ms_rtl_6km_smooth,
            "../data-raw/swe/loca2_swe/ssp585/ssp585_hist_ms_rtl_6km_smooth.tif",
            overwrite = TRUE
)
