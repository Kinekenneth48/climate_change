...
ssp585_r2_para_ms_6km <- terra::app(comb_r2,
                                    fun = gev_fit_para_mix_stat,
                                    cores = 25
)
names(ssp585_r2_para_ms_6km) <- c("loc", "loctrend", "scale", "shape", "perzero")

writeRaster(ssp585_r2_para_ms_6km,
            "../data-raw/swe/loca2_swe/ssp585/ssp585_r2_para_ms_6km.tif",
            overwrite = TRUE
)
...
ssp585_r2c_ms_rtl_6km <- terra::app(ssp585_r2_para_ms_6km,
                                    fun = simulate_loads, n = 1000000,
                                    t = 50, gr = gr_model, cores = 25
)
names(ssp585_r2c_ms_rtl_6km) <- c("RT_I", "RT_II", "RT_III", "RT_IV")
...
################################################################################
ssp585_r2c_ms_rtl_6km <- ssp585_r2c_ms_rtl_6km * 20.8855

writeRaster(ssp585_r2c_ms_rtl_6km,
            "../data-raw/swe/loca2_swe/ssp585/ssp585_r2c_ms_rtl_6km.tif",
            overwrite = TRUE
)
