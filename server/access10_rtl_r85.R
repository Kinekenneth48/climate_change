...
vic_r85c_para_ms_6km <- terra::app(comb_vic_r85,
                                    fun = gev_fit_para_mix_stat,
                                    cores = 20
)
names(vic_r85c_para_ms_6km) <- c("loc", "loctrend", "scale", "shape", "perzero")

writeRaster(vic_r85c_para_ms_6km,
            "../data-raw/swe/ACCESS1-0/vic_r85c_para_ms_6km.tif",
            overwrite = TRUE
)
...
vic_r85c_ms_rtl_6km <- terra::app(vic_r85c_para_ms_6km,
                                   fun = simulate_loads, n = 1000000,
                                   t = 50, gr = gr_model, cores = 20
)
names(vic_r85c_ms_rtl_6km) <- c("RT_I", "RT_II", "RT_III", "RT_IV")
...
################################################################################
vic_r85c_ms_rtl_6km <- vic_r85c_ms_rtl_6km * 20.8855

writeRaster(vic_r85c_ms_rtl_6km,
            "../data-raw/swe/ACCESS1-0/vic_r85c_ms_rtl_6km.tif",
            overwrite = TRUE
)
