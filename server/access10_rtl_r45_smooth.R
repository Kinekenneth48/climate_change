...
comb_vic_r45 = c(vic_hist, vic_r45)
...
vic_r45c_para_ms_6km_smooth <- terra::app(comb_vic_r45,
                                   fun = gev_fit_para_mix_stat,
                                   cores = 20
)
names(vic_r45c_para_ms_6km_smooth) <- c("loc", "loctrend", "scale", "shape", "perzero")

vic_r45c_para_ms_6km_smooth[["shape"]] = smooth_shape[["shape"]]

writeRaster(vic_r45c_para_ms_6km_smooth,
            "../data-raw/swe/ACCESS1-0/vic_r45c_para_ms_6km_smooth.tif",
            overwrite = TRUE
)
...
vic_r45c_ms_rtl_6km_smooth <- terra::app(vic_r45c_para_ms_6km_smooth,
                                  fun = simulate_loads, n = 1000000,
                                  t = 50, gr = gr_model, cores = 20
)
names(vic_r45c_ms_rtl_6km_smooth) <- c("RT_I", "RT_II", "RT_III", "RT_IV")
...
################################################################################
vic_r45c_ms_rtl_6km_smooth <- vic_r45c_ms_rtl_6km_smooth * 20.8855

writeRaster(vic_r45c_ms_rtl_6km_smooth,
            "../data-raw/swe/ACCESS1-0/vic_r45c_ms_rtl_6km_smooth.tif",
            overwrite = TRUE
)
